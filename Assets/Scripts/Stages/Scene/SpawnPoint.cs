...
namespace StageSystem
{
    ...
    public class SpawnPoint : MonoBehaviour
    {
        ...
        /// <summary>
        /// 안전한 스폰 위치 찾기 (최대 시도 횟수 제한)
        /// </summary>
        public Vector3 GetSafeSpawnPosition(int maxAttempts = 10)
        {
        ...
        public Vector3 GetDistributedSpawnPosition(int monsterIndex, int totalMonsters)
        {
            ...
            switch (spawnPattern)
            {
                case SpawnPattern.Circle:
                    return GetCirclePosition(basePosition, monsterIndex, totalMonsters);
                case SpawnPattern.Grid:
                    return GetGridPosition(basePosition, monsterIndex);
