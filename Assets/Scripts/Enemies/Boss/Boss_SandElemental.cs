...
public class Boss_SandElemental : BaseEnemy
{
    ...
    protected override void OnAwakeInitialize()
    {
        ...
        Dbg.Log($"[Boss_SandElemental] {gameObject.name} Awake 초기화 완료");
    }
    ...
    protected override void OnStartInitialize()
    {
        ...
        Dbg.Log($"[Boss_SandElemental] {gameObject.name} Start 초기화 완료");
    ...
    protected override void InitializeAttackSystem()
    {
        ...
        if (meleeAttack != null)
        {
            ...
            Dbg.Log($"[Boss_SandElemental] {gameObject.name} MeleeAttack 시스템 초기화 완료");
        }
        else
        {
        ...
        if (bossAttack != null)
        {
            ...
            Dbg.Log($"[Boss_SandElemental] {gameObject.name} BossAttackBehaviour 시스템 초기화 완료");
        }
        else
        {
    ...
    private void ApplyBossSandElementalSpecificSettings()
    {
        ...
        if (phaseController != null)
        {
            Dbg.Log($"[Boss_SandElemental] 페이즈 시스템 활성화: {phaseController.TotalPhases}개 페이즈");
        }
    }
